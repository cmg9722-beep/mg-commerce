...
def seed_initial_data():
    ...
    suppliers = [
        ...
        (2, "광동미고과기",        "广东米高科技有限公司",       "广东米高科技",              "광동",     "5년+",   "45%",
         "무료",   "¥1.80",     "¥1.50","10", "RoHS인증완료, 한국수출경험, 대응매우빠름 | 쿠팡이미지완료",
         "입고완료", "타배입고완료, 배송비결제완료(₩8,250) | 쿠팡이미지완료", "SF1566001528275(SF)"),
        (4, "심천협성",            "深圳协成科技",               "-",                         "심천",     "20년+",  "-",
         "미정",   "미정",      "미정", "미정","BSCI/ISO9001/TUV인증, 한국수출경험, 이메일회신대기",
         "이메일회신대기", None, None),
        (4, "앤커럴",              "Ankeral Technology Co., Ltd","-",                         "심천",     "CE/FCC/RoHS","-",
         "$13 (No.1 $3+No.2 $5+배송$5)","미정","미정","미정","CE/FCC/RoHS인증, 월마트납품, OEM가능, 샘플비확정$13",
         "샘플비결제대기", None, None),
        (5, "블루버터플라이(란디에)","佛山南海领途袜业有限公司",  "LINGTU",                    "불산",     "-",      "-",
         "미정",   "미정",      "미정", "미정","1688:lingtuwaye.1688.com, 4/13발송후 답장없음",
         "답장대기", None, None),
    ]
    for s in suppliers:
        conn.execute(
